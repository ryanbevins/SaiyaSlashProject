...
ANovaStrikeCharacter::ANovaStrikeCharacter()
{
...
void ANovaStrikeCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("Turn Right / Left Gamepad", this, &ANovaStrikeCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("Look Up / Down Mouse", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("Look Up / Down Gamepad", this, &ANovaStrikeCharacter::LookUpAtRate);

	// handle touch devices
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ANovaStrikeCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ANovaStrikeCharacter::TouchStopped);
}

void ANovaStrikeCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
	Jump();
}
...
void ANovaStrikeCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
